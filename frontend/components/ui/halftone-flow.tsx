...
html, body { width: 100% !important; height: 100% !important; min-height: 0 !important; margin: 0 !important; padding: 0 !important; overflow: hidden !important; background:  !important; }
...
function HalftoneFlow({
  ...
  const filter =
    safeHue === 0 && safeSaturation === 1 && safeBrightness === 1
      ? undefined
      : hue-rotate(deg) saturate() brightness();
                ...
                <div class=flex flex-row items-center gap-4 mt-10 mr-2>
                    ...
                    <div class=flex -space-x-3>
                        ...
                        <div class=w-8 h-8 rounded-full p-[2px] bg-gradient-to-br from-white/50 to-white/10 bg-black shadow-sm>
                            <img class=w-full h-full rounded-full object-cover src=https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=100&auto=format&fit=crop&q=80 alt=User avatar>
                        </div>
                        <div class=w-8 h-8 rounded-full p-[2px] bg-gradient-to-br from-white/50 to-white/10 bg-black shadow-sm>
                            <img class=w-full h-full rounded-full object-cover src=https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=100&auto=format&fit=crop&q=80 alt=User avatar>
                        </div>
                        <div class=w-8 h-8 rounded-full p-[2px] bg-gradient-to-br from-white/50 to-white/10 bg-black shadow-sm>
                            <img class=w-full h-full rounded-full object-cover src=https://images.unsplash.com/photo-1492562080023-ab3db95bfbce?w=100&auto=format&fit=crop&q=80 alt=User avatar>
                        </div>
                        <div class=w-8 h-8 rounded-full p-[2px] bg-gradient-to-br from-white/50 to-white/10 bg-black shadow-sm>
                            <img class=w-full h-full rounded-full object-cover src=https://images.unsplash.com/photo-1517841905240-472988babdf9?w=100&auto=format&fit=crop&q=80 alt=User avatar>
                        </div>
                    </div>
                </div>
            </div>
